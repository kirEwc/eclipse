...
const requirementsList: Requirement[] = [
  {
    ...
    backgroundImage:
      "bg-gradient-to-br from-cyan-400 via-green-400 to-green-400",
  },
  {
...
const TravelRequirements: React.FC = () => {
  return (
    <div className="p-6 max-w-5xl mx-auto mt-10">
      <h1 className="text-3xl font-extrabold mb-10 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">
          ...
          >
            ...
            <ul className="list-none space-y-3">
              {item.requirements.map((req, index) => (
                <li
                  key={index}
                  className="flex items-start text-white bg-white/20 p-3 rounded-lg backdrop-blur-md hover:bg-white/30 transition-colors duration-300"
                >
